...
$Server->on('request', static function (Request $Request, Response $Response): void {
   ...
   try {
      ...
      $body = match ($path) {
         ...
         '/database/native/ping', '/database/resource/ping', '/database/runner/ping' => SwooleDatabaseBenchmark::ping(),
         '/database/native/parameters', '/database/resource/parameters', '/database/runner/parameters' => SwooleDatabaseBenchmark::parameters(),
         '/database/native/pool', '/database/resource/pool', '/database/runner/pool' => SwooleDatabaseBenchmark::pool(),
         '/database/native/sleep', '/database/resource/sleep', '/database/runner/sleep' => SwooleDatabaseBenchmark::sleep(),
         default => null,
      };
