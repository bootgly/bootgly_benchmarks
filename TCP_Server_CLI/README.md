...
./bootgly test benchmark TCP_Server_CLI --opponents=bootgly \
...
`bootgly/storage/tests/benchmarks/TCP_Server_CLI/runs/<run-id>/`; marks,
...
./bootgly test benchmark TCP_Server_CLI --opponents=bootgly --loads=default:*
...
```
bootgly/storage/tests/benchmarks/TCP_Server_CLI/runs/<run-id>/marks/result_bench.marks
```
