 ...
 *
 * Setup: run `composer install` inside bootables/laravel/ first.
 */

$bootablesDir = __DIR__ . '/../../bootables/laravel';
$bootglyDir = __DIR__ . '/../../../../bootgly';

require $bootablesDir . '/vendor/autoload.php';
...
$viewsPath = $bootablesDir . '/views';
$cachePath = $bootablesDir . '/cache';
